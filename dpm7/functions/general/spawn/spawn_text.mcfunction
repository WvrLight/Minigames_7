...
# VERSION TITLE
summon text_display -7 71 -28 {Tags:["spawnText","infoText","version"],text:'[{"text":"Server Version: ","color":"light_purple","bold":true},{"text":"b2","color":"white"}]'}
...
execute as @e[tag=infoText] at @s run tp @s ~-0.5 ~ ~ -90 0