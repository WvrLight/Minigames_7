...
execute at @e[tag=statueLight,type=armor_stand] rotated 0 0 positioned ^ ^ ^0.45 run summon item_display ~ ~0.5 ~ {Tags:["spawnStatue","statueLight"],item:{id: "minecraft:diamond_sword", Count: 1},transformation:{translation:[0,0,0],scale:[1f,1f,1f],left_rotation:[0f,0f,1f,0.425f],right_rotation:[0f,0f,0f,1f]}}
...
# RAPH
summon armor_stand -2 64 -14 {Invulnerable:1b,ShowArms:1b,NoBasePlate:1b,Tags:["spawnStatue","statueRaph","statueLeft"],ArmorItems:[{id:"minecraft:netherite_boots",Count:1b},{id:"minecraft:netherite_leggings",Count:1b},{id:"minecraft:netherite_chestplate",Count:1b},{id:"minecraft:player_head",Count:1b,tag:{SkullOwner:"Waraid3r"}}]}
